...
public class NhanVienDAO extends GymSoftwareDAO<NhanVien, String> {
    ...
    final String INSERT_SQL = "INSERT into NhanVien(MaNV,HoTen,MatKhau,NgaySinh,SDT,Email,VaiTro,GioiTinh,Luong,Hinh)values(?,?,?,?,?,?,?,?,?,?)";
    final String UPDATE_SQL = "UPDATE NhanVien SET HoTen = ?,MatKhau = ?,NgaySinh = ?,SDT = ?,Email = ?,VaiTro = ?,GioiTinh = ?,Luong = ?,Hinh = ? where MaNV=?";
    ...
    protected List<NhanVien> selectBySql(String sql, Object... args) {
        ...
        try {
            ...
            while (rs.next()) {
                ...
                entity.setLuong(rs.getString("Luong"));
